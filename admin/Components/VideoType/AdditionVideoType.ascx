<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionVideoType.ascx.cs" Inherits="Admin_Components_VideoType_AdditionVideoType" %>
...
<div class="form-view">
    <div class="frow">
        <div class="frow-wrapp">
            <div class="label">
                Kiểu video<span class="validate">*</span>
            </div>
            <div class="input">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadEditor Height="300px" Width="98%" ID="reEmbedCode" EnableResize="true" ToolbarMode="ShowOnFocus" ToolsFile="~/admin/XMLData/Editor/SmallSetOfTools.xml"
...
<telerik:RadInputManager runat="server" ID="rimBICCMS" EnableEmbeddedSkins="false" Skin="BICCMS">
    <telerik:TextBoxSetting BehaviorID="bhName" EmptyMessage="Nhập kiểu video" Validation-IsRequired="true">
        <TargetControls>
