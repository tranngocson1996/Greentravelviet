<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionDocument.ascx.cs" Inherits="Admin_Components_Document_EditionDocument" %>
            ...
            <div class="input">
                <div class="upload-control">
                    ...
                    <div class="note_upload">
                        ( Định dạng cho phép:*.txt,*.doc,*.docx,*.ppt, *.pptx,*.xls,*.xlsx,*.pdf,*.tif,*.zip,*.rar,*.xps )<br />
                        <asp:LinkButton ID="linkdoc" Text="linkDoc" runat="server" OnClick="linkdoc_Click" />
                    </div>
                </div>
            </div>
        </div>
