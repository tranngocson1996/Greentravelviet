<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionFAQ.ascx.cs" Inherits="Admin_Components_FAQ_EditionFAQ" %>
<div class="form-tool">
    <bic:ToolBar ID="tbTop" runat="server" />
    <asp:LinkButton ID="lbtnSave" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="Update">Lưu nội dung</asp:LinkButton>
</div>
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadEditor Height="300px" Width="98%" ID="txtFaqQuestion" EnableResize="true" ToolbarMode="ShowOnFocus" ToolsFile="~/admin/XMLData/Editor/SmallSetOfTools.xml"
                    ...
                    <ImageManager DeletePaths="~/FileUpload/Images/Editor" UploadPaths="~/FileUpload/Images/Editor" ViewPaths="~/FileUpload/Images/Editor" MaxUploadFileSize="1024000" />
                    <DocumentManager DeletePaths="~/FileUpload/Documents" UploadPaths="~/FileUpload/Documents" ViewPaths="~/FileUpload/Documents" MaxUploadFileSize="10240000" />
...
<div class="form-tool-bottom">
    ...
    <asp:LinkButton ID="lbtnSave2" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="Update">Lưu nội dung</asp:LinkButton>
</div>
