<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionTypeOfRoom.ascx.cs"
    Inherits="Admin_Components_TypeOfRoom_AdditionTypeOfRoom" %>
<%@ Import Namespace="BIC.Utils" %>
<div class="form-tool">
    <bic:ToolBar ID="tbTop" runat="server" />
    <asp:LinkButton ID="lbtnSave" CssClass="btn-save" runat="server" OnCommand="Save"
        ValidationGroup="admin" CommandName="AddNew"><%= BicResource.GetValue("Admin","Admin_Save") %></asp:LinkButton>
</div>
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtName" CssClass="input-text" Width="90%" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtPrice" CssClass="input-text" Width="100px" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtMaxPerson" CssClass="input-text" Width="100px" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:CheckBox ID="chkIsActive" Checked="true" CssClass="" Width="" runat="server" /></div>
        </div>
    </div>
</div>
<div class="form-tool-bottom">
    ...
    <asp:LinkButton ID="lbtnSave2" CssClass="btn-save" runat="server" OnCommand="Save"
        ValidationGroup="admin" CommandName="AddNew">
...
<telerik:RadInputManager runat="server" ID="rimBICCMS" EnableEmbeddedSkins="false"
    ...
    <telerik:TextBoxSetting BehaviorID="bhName" EmptyMessage="Nhập kiểu giường" Validation-IsRequired="true"
        Validation-ValidationGroup="admin">
        <TargetControls>
            <telerik:TargetInput ControlID="txtName" />
        </TargetControls>
    </telerik:TextBoxSetting>
    <telerik:NumericTextBoxSetting BehaviorID="bhMaxPerson" Type="Number" DecimalDigits="0">
        <TargetControls>
            <telerik:TargetInput ControlID="txtMaxPerson" />
        </TargetControls>
