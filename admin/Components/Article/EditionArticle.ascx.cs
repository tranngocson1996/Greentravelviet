...
public partial class Admin_Components_Article_EditionArticle : BaseUserControl
{
    ...
    private void LoadDataFromEntity()
    {
        ...
        if (!string.IsNullOrEmpty(articleEntity.Source))
        {
            ...
            txtSource.Text = articleEntity.Source;
        ...
        reBody.CssFiles.Add(new EditorCssFile("~/BICSkins/BICCMS/Editor/EditorContentAreaStyles.css"));
