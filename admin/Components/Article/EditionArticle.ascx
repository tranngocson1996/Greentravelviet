<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionArticle.ascx.cs" Inherits="Admin_Components_Article_EditionArticle" %>
...
<%@ Register Src="CommentArticle.ascx" TagName="CommentArticle" TagPrefix="uc3" %>
<div class="form-tool">
...
<div class="form-view">
    ...
    <%--Ban lãnh đạo--%>
    <asp:UpdatePanel runat="server" ID="udpLeader" UpdateMode="Conditional">
        <ContentTemplate>
                ...
                <div class="frow-wrapp">
                    <div class="label">
                        <telerik:RadCodeBlock ID="RadCodeBlock39" runat="server">
                            <%=BicResource.GetValue("Admin","Admin_IsLeader") %>
                        </telerik:RadCodeBlock>
                    </div>
                    <div class="input">
                        <asp:CheckBox runat="server" ID="chkIsLeader" AutoPostBack="True" OnCheckedChanged="ChkIsLeaderCheckedChanged" />
                    </div>
                </div>
            </div>
            <asp:Panel runat="server" ID="pnLeader" Visible="False">
                <div class="frow ">
                    <div class="frow-wrapp">
                        <div class="label">
                            <telerik:RadCodeBlock ID="RadCodeBlock40" runat="server">
                                <%=BicResource.GetValue("Admin","Admin_Vocative") %>
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                            <%--<asp:DropDownList runat="server" ID="ddlVocative" Width="100px">
                                <Items>
                                    <asp:ListItem Value="Ông" Text="Ông"></asp:ListItem>
                                    <asp:ListItem Value="Bà" Text="Bà"></asp:ListItem>
                                </Items>
                            </asp:DropDownList>--%>
                             <asp:TextBox ID="txtVocative" runat="server" CssClass="input-text" MaxLength="50" Width="20%" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="frow-wrapp">
                        <div class="label">
                            <telerik:RadCodeBlock ID="RadCodeBlock41" runat="server">
                                <%=BicResource.GetValue("Admin","Admin_FullName") %>
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                            <asp:TextBox ID="txtFullName" runat="server" CssClass="input-text" MaxLength="50" Width="40%" />
                            (Max 50)
                        </div>
                    </div>
                </div>
                    ...
                    <div class="frow-wrapp">
                        <div class="label">
                            <telerik:RadCodeBlock ID="RadCodeBlock42" runat="server">
                                <%=BicResource.GetValue("Admin","Admin_Position") %>
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                            <asp:TextBox ID="txtPosition" runat="server" CssClass="input-text" MaxLength="300" Width="84%" />
                            (Max 300)
                        </div>
                    </div>
                </div>
        ...
        <div class="frow-wrapp">
            ...
            <div class="input group-item">
                ...
                <div class="col c3">
                    ...
                    <div class="line">
                        ...
                        <div class="input">
                            ...
                            <telerik:RadNumericTextBox ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true"
                                ...
                                ID="ntxPosition" Width="120px" DataType="System.Int64">
                    ...
                    <div class="line hidden">
                        <div class="label2 fl arrow">
                            <telerik:RadCodeBlock ID="RadCodeBlock38" runat="server">
                                <%=BicResource.GetValue("Admin","ToolbarVisible") %>
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                            <asp:CheckBox runat="server" ID="chkIsShowToolbar" />
                        </div>
                    </div>
                      <div class="line hidden">
                        <div class="label2 fl arrow">
                            <telerik:RadCodeBlock ID="RadCodeBlock43" runat="server">
                                <%=BicResource.GetValue("Admin","TitleVisible") %>
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                            <asp:CheckBox runat="server" ID="chkIsShowTitle" />
                        </div>
                    </div>
                    <div class="line hidden">
                        <div class="label arrow">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock26" runat="server">
        <div id="ArrayImage" class="frow <%=BicXML.ToBoolean("EnableArrayImage","SettingArticle") == false? "hidden" : "" %>">
            <div class="frow-wrapp">
                <div class="label">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <bic:Editor Height="200px" Skin="Office2007" Width="98%" ID="reBriefDescription" ToolbarMode="ShowOnFocus" ToolsFile="~/admin/XMLData/Editor/SmallSetOfTools.xml" runat="server" StripFormattingOnPaste="NoneSupressCleanMessage, MSWord, MSWordNoFonts" />
            </div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <bic:Editor Height="500px" ID="reBody" Width="100%" EmbedCssFiles="false" ToolsFile="~/admin/XMLData/Editor/RibbonFullSetOfTools.xml" ContentFilters="None" runat="server" StripFormattingOnPaste="NoneSupressCleanMessage, MSWord, MSWordNoFonts" ToolbarMode="RibbonBarShowOnFocus" Skin="Office2007" />
            </div>
        </div>
    </div>
    <telerik:RadCodeBlock ID="RadCodeBlock34" runat="server">
        <div class="frow  <%=BicXML.ToBoolean("EnableRelatedNews","SettingArticle") == false? "hidden" : "" %>">
            <div class="frow-wrapp">
                <div class="label">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock36" runat="server">
        <div class="frow  <%=BicXML.ToBoolean("EnableTags","SettingArticle") == false? "hidden" : "" %>">
            <div class="frow-wrapp">
                <div class="label">
