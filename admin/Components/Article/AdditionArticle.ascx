<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionArticle.ascx.cs"
    Inherits="Admin_Components_Article_AdditionArticle" %>
...
<%@ Register Src="~/admin/Components/Video/VideoSelector.ascx" TagName="VideoSelector"
    TagPrefix="bic" %>
<%@ Register Src="RelatedArticle.ascx" TagName="relatedarticle" TagPrefix="uc2" %>
...
<div class="form-view">
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                    <div class="cot-tree">
                        <telerik:RadTreeView runat="server" Skin="Outlook" Width="280px" OnClientNodeChecked="ClientNodeChecked"
                    ...
                    <div class="cot-tree">
                        <telerik:RadTreeView runat="server" Skin="Outlook" CheckBoxes="true" ID="RadTreeView1"
                            PersistLoadOnDemandNodes="true" LoadingStatusPosition="AfterNodeText" CollapseAnimation-Duration="0" OnClientNodeChecked="ClientNodeChecked"
            ...
            <div class="input group-item">
                ...
                <div class="col c1">
                    <telerik:RadCodeBlock ID="RadCodeBlock33" runat="server">
                        <div class="line hidden <%=BicXML.ToBoolean("EnableComment","SettingProduct") == false? "hidden" : "" %>">
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                <bic:Editor Height="200px" Skin="Office2007" Width="98%" ID="reBriefDescription"
                    ...
                    runat="server" StripFormattingOnPaste="NoneSupressCleanMessage, MSWord, MSWordNoFonts" />
            </div>
        </div>
    </div>
    ...
    <%--  <div class="frow">
                <div class="frow-wrapp">
                    ...
                    <div class="input">
                       <div style="width: 795px;background: url(/Styles/img/sd_history.png) no-repeat left top;margin-top:-10px;height: 100px;padding-top: 18px">
                           <div style="width: 150px;float: left;margin-right: 55px;height: 100%">
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="updatepn">
        <ContentTemplate>
            <div class="frow hidden">
                <div class="frow-wrapp">
                    <div class="label">
                        <telerik:RadCodeBlock ID="RadCodeBlock37" runat="server">
                            <%=BicResource.GetValue("Admin","Admin_History") %>
                        </telerik:RadCodeBlock>
                    </div>
                    <div class="input">
                        <asp:CheckBox runat="server" ID="chkHistory" AutoPostBack="True" OnCheckedChanged="ChkHistoryCheckedChanged" />

                        <asp:Button runat="server" ID="btnAddRow" Visible="False" Text="Click để thêm dòng" OnClick="BtnAddRowClick" />
                    </div>
                </div>
            </div>
            <div class="frow">
                <div class="frow-wrapp">
                    ...
                    <div class="input">
                        ...
                        <bic:Editor Height="500px" ID="reBody" Width="100%" ToolsFile="~/admin/XMLData/Editor/RibbonFullSetOfTools.xml"
                            ContentFilters="None" runat="server" StripFormattingOnPaste="NoneSupressCleanMessage, MSWord, MSWordNoFonts"
                            ToolbarMode="RibbonBar" Skin="Office2007"></bic:Editor>
                    </div>
                </div>
            </div>
        </ContentTemplate>
