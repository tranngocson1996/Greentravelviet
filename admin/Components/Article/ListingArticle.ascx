<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingArticle.ascx.cs"
    Inherits="Admin_Components_Article_ListingArticle" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <div class="input-box">
                ...
                <div class='item  hidden <%=BicXML.ToBoolean("EnableComment","SettingArticle") == false? "hidden" : "" %>' style="display: none !important">
                    <div class="label">
            ...
            <div class="input-side">
                <div class="tree-box">
                    ...
                    <div style="background-color: #FFF; width: 220px; height: 30px; padding-top: 5px; padding-left: 10px; font-size: 13px">
                        <asp:DropDownList runat="server" ID="rblSort" Width="170px" AutoPostBack="True">
        ...
        <div class="grid-side">
            ...
            <div class="deleteUser">
                ...
                <telerik:RadCodeBlock ID="RadCodeBlock4" runat="server">
                    <a class='<%=Edited== false? "hidden" : "btn-movenew" %>' onclick="onClickedMove();">
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="<%$Resources:Admin,System_Hot%>" UniqueName="TemplateColumn" HeaderStyle-Width="60px">
                            <ItemTemplate>
