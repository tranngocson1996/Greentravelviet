<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RelatedArticle.ascx.cs" Inherits="admin_Components_Article_RelatedArticle" %>
<%@ Import Namespace="BIC.Utils" %>

<div class="selected-list">
    <div style="font-weight: bold;">
        <asp:LinkButton runat="server" OnClick="Unnamed_Click1" Font-Underline="true"><%=BicResource.GetValue("Admin","Admin_Article_SelectRelevantInformationFromTheMatch") %></asp:LinkButton>
    </div>
...
<telerik:RadAjaxPanel runat="server" ID="radAjax">
    <asp:Panel runat="server" ID="listSelect" Style="display: block; height: auto; left: 326px; outline: 0px none; top: 549px; width: 690px; z-index: 1002;" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable fixed" TabIndex="-1" role="dialog" aria-labelledby="ui-dialog-title-04644c8b64f80a81375df2e2d1" Visible="false">
        <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
            <span class="ui-dialog-title" id="Span1"><%=BicResource.GetValue("Admin","Admin_Article_RelatedNewsList") %></span><asp:LinkButton runat="server" OnClick="Unnamed_Click" class="ui-dialog-titlebar-close ui-corner-all" role="button"><span class="ui-icon ui-icon-closethick"><%=BicResource.GetValue("Admin","Admin_Article_close") %></span></asp:LinkButton>
        </div>
...
<style type="text/css">
    .btnSearchRelated {
        background: url("/admin/Styles/icon/btn_search_40x20.png");
