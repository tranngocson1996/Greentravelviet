<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingDistrict.ascx.cs"
    Inherits="Admin_Components_District_ListingDistrict" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="input-box">
            <div class="item first">
                <div class="item">
                    ...
                    <div class="input">
                        <bic:DropBoolean runat="server" ID="ddlCityID" OnSelectedIndexChanged="ddlCityID_OnSelectedIndexChanged"
                            AutoPostBack="True" />
                    </div>
                </div>
                <div class="item bg_none">
                    ...
                    <div class="input">
                        <bic:DropBoolean runat="server" ID="ddlIsActive" OnSelectedIndexChanged="ddlIsActive_OnSelectedIndexChanged"
                            AutoPostBack="True" />
                    </div>
                </div>
            </div>
        ...
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("DistrictID");
            ...
            <telerik:RadGrid ID="rgManager" EnableViewState="false" EnableEmbeddedSkins="false"
                Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter" AllowPaging="True"
                PageSize="10" AllowSorting="true" AllowCustomPaging="false" AllowAutomaticDeletes="true"
                ShowHeader="true" AutoGenerateColumns="False" AllowMultiRowSelection="true" OnNeedDataSource="rgManager_NeedDataSource"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                    DataKeyNames="DistrictID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tên Quận/Huyện" DataField="DistrictName" />
                        <telerik:GridTemplateColumn HeaderText="Phí chuyển phát nhanh" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%# string.Format("{0:N0}", BicConvert.ToDecimal(Eval("ChuyenNhanh"))) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Đk miễn phí chuyển nhanh" HeaderStyle-Width="175px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%# string.Format("{0:N0}", BicConvert.ToDecimal(Eval("MienPhiNhanh"))) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Phí chuyển chậm" HeaderStyle-Width="150px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%# string.Format("{0:N0}", BicConvert.ToDecimal(Eval("ChuyenCham"))) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Đk miễn phí chuyển chậm" HeaderStyle-Width="175px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <%# string.Format("{0:N0}", BicConvert.ToDecimal(Eval("MienPhiCham"))) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Thứ tự" HeaderStyle-Width="110px">
                            <ItemTemplate>
                                ...
                                <div style="float: right; position: relative;">
                                    <asp:ImageButton runat="server" ImageUrl="~/Admin/Styles/Icon/updown_30x20.png" ID="lbtnChange"
                                        CommandName="Change" />
                                </div>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
