...
public partial class Admin_Components_Article_AdditionArticleGallery : BaseUserControl
{
    private int _id;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MenuUserUtils.BindingRadTreeView(tvMenuUser, ddlLanguage.SelectedValue, "gallery", "cot1");
        MenuUserUtils.BindingRadTreeView(RadTreeView1, ddlLanguage.SelectedValue, "gallery", "cot2");
        MenuUserUtils.BindingRadTreeView(RadTreeView2, ddlLanguage.SelectedValue, "gallery", "cot3");
    ...
    private void LoadDataFromEntity()
    {
        ...
        //chkHome.Checked = BicConvert.ToBoolean(articleEntity.IsHome);   //Truong nay bang true la thu vien anh , false la video
        //RelatedArticle1.MenuUserId = 0 + MenuUserBiz.GetCheckedNodes(tvMenuUser);
        ddlType.SelectedValue = articleEntity.TinLienQuan;   //Luu link video
        ...
        var articleEntity = new ArticleEntity
                                {
                                    ...
                                    TinLienQuan = ddlType.SelectedValue,  //Luu link video,
                                    ImageArray = ismImageId.ImageIDArray,
                                    TypeOfControl = 2, //Thư viện ảnh
            ...
            switch (e.CommandName)
            {
                case "AddNew":
                    ...
                    else
                    {
                        ...
                        {
                            BicAjax.Alert("Bạn chưa chọn kiểu bản ghi");
                        }
                    }
                    break;
            }
