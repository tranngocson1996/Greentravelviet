...
public partial class Admin_Components_ArticleGallery_EditionArticleGallery : BaseUserControl
{
    private int _id;
    ...
    private void LoadDataFromEntity()
    {
        ...
        ddlType.SelectedValue = articleEntity.TinLienQuan;
    ...
    private ArticleEntity LoadDataToEntity()
    {
        ...
        articleEntity.TinLienQuan = ddlType.SelectedValue;
        articleEntity.ImageArray = ismImageId.ImageIDArray;
        articleEntity.TypeOfControl = 2;
