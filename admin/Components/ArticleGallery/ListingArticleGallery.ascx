<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingArticleGallery.ascx.cs"
    Inherits="Admin_Components_ArticleGallery_ListingArticleGallery" %>
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <div class="input-box">
                ...
                <div class='item'>
                    ...
                    <div class="input">
                        <asp:DropDownList runat="server" ID="ddlType" CssClass="input-select" OnSelectedIndexChanged="ddlType_OnSelectedIndexChanged" AutoPostBack="True">
