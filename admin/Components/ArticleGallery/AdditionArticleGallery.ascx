<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionArticleGallery.ascx.cs"
    Inherits="Admin_Components_Article_AdditionArticleGallery" %>
...
<%@ Register Src="~/admin/Components/Video/VideoSelector.ascx" TagName="VideoSelector"
    TagPrefix="bic" %>
<%@ Register Src="~/admin/Components/Article/RelatedArticle.ascx" TagName="relatedarticle" TagPrefix="uc2" %>
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                    ...
                    <div class="cot-tree">
                        <telerik:RadTreeView runat="server" Skin="Outlook" CheckBoxes="true" ID="RadTreeView1" OnClientNodeChecked="ClientNodeChecked"
                            PersistLoadOnDemandNodes="true" LoadingStatusPosition="AfterNodeText" CollapseAnimation-Duration="0"
