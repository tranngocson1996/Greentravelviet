<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionArticleGallery.ascx.cs" Inherits="Admin_Components_ArticleGallery_EditionArticleGallery" %>
...
<div class="form-view">
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:DropDownList runat="server" ID="ddlType" CssClass="input-select">
                    <asp:ListItem Text="-- Chọn --" Value="2" />
                    <asp:ListItem Text="Thư viện ảnh" Value="1" />
                    <asp:ListItem Text="Thư viện video" Value="0" />
                </asp:DropDownList>
            </div>
        </div>
    </div>
    ...
    <div class="frow alt">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtLink" runat="server" CssClass="input-text" MaxLength="250" Width="84%" />
                (Max 250)
            </div>
        </div>
    </div>
    ...
    <div id="ArrayImage" class="frow alt">
        <div class="frow-wrapp">
            <div class="label">
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <bic:Editor Height="700px" ID="reBody" Width="98%" EmbedCssFiles="false" ToolsFile="~/admin/XMLData/Editor/RibbonFullSetOfTools.xml" ContentFilters="None" runat="server" StripFormattingOnPaste="NoneSupressCleanMessage, MSWord, MSWordNoFonts" ToolbarMode="RibbonBarShowOnFocus" Skin="Office2007" />
            </div>
        </div>
    </div>
    <div class="frow hidden">
