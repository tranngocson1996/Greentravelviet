<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommentArticleGallery.ascx.cs" Inherits="admin_Components_Article_CommentArticleGallery" %>
...
<div style="background: #9EC4D4; text-align: left; width:740px">
    <bic:PagerUI runat="server" ID="pRelatedArticle" PagerUIStep="10" Label="Trang: " PageSize="10" />
</div>
