<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionVideo.ascx.cs"
...
<%@ Register Src="~/admin/Components/Video/VideoSelector.ascx" TagName="VideoSelector"
    TagPrefix="bic" %>
<%@ Register Src="RelatedVideo.ascx" TagName="relatedarticle" TagPrefix="uc2" %>
...
<div class="form-view">
    ...
    <div class="frow alt hidden none">
        <div class="frow-wrapp">
            <div class="label">
