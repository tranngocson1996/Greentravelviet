...
public partial class Admin_Components_Video_ListingArticle : BaseUserControl
{
    ...
    {
        MenuUserUtils.BindingRadTreeView(tvMenuUser, ddlLanguage.SelectedValue, "video");
    }
    ...
    private void GetDataSource()
    {
        ...
        // Fix  Lấy ra danh sách Video
        bicData.Conditioning.Add(new ConditioningItem("TypeOfControl", "3", Operator.EQUAL, CompareType.NUMERIC));
