<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionEmail.ascx.cs" Inherits="Admin_Components_Email_EditionEmail" %>
...
<div class="frow"> <div class="frow-wrapp"> <div class="label">Ngày tạo </div> <div class="input"><asp:TextBox ID="txtCreatedTime" CssClass="" Width="" runat="server"/></div></div></div>
