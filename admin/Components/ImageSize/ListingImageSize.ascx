<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingImageSize.ascx.cs" Inherits="Admin_Components_ImageSize_ListingImageSize" %>
        ...
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {key = args.getDataKeyValue("ImageSizeID");document.getElementById("radGridSelectedRowIndex").value = key;}
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false" Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter" AllowPaging="True"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..." DataKeyNames="ImageSizeID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tiêu đề" DataField="Name" />
                        <telerik:GridBoundColumn HeaderText="Rộng" DataField="ImageWidth" HeaderStyle-Width="50" />
                        <telerik:GridBoundColumn HeaderText="Cao" DataField="ImageHeight" HeaderStyle-Width="50" />
                        <telerik:GridTemplateColumn HeaderText="Mặc định" HeaderStyle-Width="50">
                            <ItemTemplate>
