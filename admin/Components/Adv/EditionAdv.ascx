<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionAdv.ascx.cs" Inherits="Admin_Components_Adv_EditionAdv" %>
<%@ Import Namespace="BIC.Utils" %>
<style type="text/css">.RadTreeView.RadTreeView_Outlook {float:left;}</style>
<div class="form-tool">
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <bic:RequiredURL ID="txtURL" CssClass="input-text" Width="94%" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadTreeView runat="server" CheckChildNodes="true" Skin="Outlook" Width="280px" CheckBoxes="true" ID="tvOther" PersistLoadOnDemandNodes="true" LoadingStatusPosition="AfterNodeText"
                                     CollapseAnimation-Duration="200" ExpandAnimation-Duration="200" ExpandAnimation-Type="InQuart" SingleExpandPath="False" OnNodeExpand="tvMenuUser_NodeExpand" OnNodeCheck="tvOther_OnNodeCheck">
                </telerik:RadTreeView>
                <telerik:RadTreeView runat="server" CheckChildNodes="true" Skin="Outlook" Width="280px" CheckBoxes="true" ID="tvnews" PersistLoadOnDemandNodes="true" LoadingStatusPosition="AfterNodeText"
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:CheckBox ID="chkIsActive" runat="server" /></div>
        </div>
    </div>
</div>
