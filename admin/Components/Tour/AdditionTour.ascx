<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionTour.ascx.cs" Inherits="Admin_Components_Tour_AdditionTour" %>
...
<script type="text/javascript">
    function OnClientDropDownClosedHandler(sender, eventArgs) {
        ...
        if ($("#ddlLichTrinh").val() != "") {
            ...
            var item = combo.findItemByText(list[0]);
            if (item) {
                item.select();
            }
        }
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtGiaHienThi" CssClass="input-text" Width="195" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtSoNgay" CssClass="input-text" Width="200" runat="server" ClientIDMode="Static" />
            </div>
        </div>
    </div>
    <div class="frow">
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtStart" CssClass="input-text" Width="200" runat="server" ClientIDMode="Static" />
            </div>
        </div>
    </div>
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtEnd" CssClass="input-text" Width="200" runat="server" ClientIDMode="Static" />
            </div>
        </div>
    </div>
    <div class="frow hidden">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadComboBox ClientIDMode="Static" ID="ddlLichTrinh" runat="Server" HighlightTemplatedItems="true" Width="200" CssClass="input-select" CheckedItemsTexts="DisplayAllInInput"
                    DataTextField="Name" DataValueField="TourRouteID" CheckBoxes="True" CollapseDelay="300" AllowCustomText="false" OnClientDropDownClosed="OnClientDropDownClosedHandler">
                </telerik:RadComboBox>
            </div>
        </div>
    </div>
        ...
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadNumericTextBox ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true"
                    ...
                    ID="txtPosition" Width="120px" DataType="System.Int64" MinValue="1">
    ...
    <div class="form-tool-bottom">
        ...
        <asp:LinkButton ID="lbtnSave2" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="AddNew">
