<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewCategory.ascx.cs" Inherits="Admin_Components_Category_ViewCategory" %>
...
<div class="frow"> <div class="frow-wrapp"> <div class="label">Giá trị </div> <div class="input"><asp:Label ID="lblDBValue" CssClass="Label" runat="server"/></div></div> </div>
