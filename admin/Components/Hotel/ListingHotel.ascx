<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingHotel.ascx.cs" Inherits="Admin_Components_Hotel_ListingHotel" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("HotelID");
            ...
            <telerik:RadAjaxLoadingPanel ID="rgManagerLoading" runat="server" Transparency="25">
                <center>
                    <table width="100%">
                        <tr>
                            <td>
                                <img alt="Loading..." style="margin-top: 80px; border: 0;" src='<%=Page.ResolveUrl("~/admin/styles/img/loading_bicweb_150x29.gif")%>' />
                            </td>
                        </tr>
                    </table>
                </center>
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false" Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter"
                ...
                OnDeleteCommand="rgManager_DeleteCommand" OnItemCommand="rgManager_ItemCommand">
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..." DataKeyNames="HotelID"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tên khách sạn" DataField="HotelName" />
                        <telerik:GridTemplateColumn HeaderText="Duyệt" UniqueName="TemplateColumn" HeaderStyle-Width="50px">
                            <ItemTemplate>
                                <asp:ImageButton ID="ibtnIsActive" BorderWidth="0px" CommandName="IsActive" CommandArgument='<%#Eval("IsActive") %>' Enabled='<%#Approved%>'
