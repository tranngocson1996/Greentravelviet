<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionControl.ascx.cs" Inherits="Admin_Components_Control_AdditionControl" %>
<%@ Import Namespace="BIC.Utils" %>
<div class="form-tool">
    <bic:ToolBar ID="tbTop" runat="server" />
    <asp:LinkButton ID="lbtnSave" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="AddNew"><%=BicResource.GetValue("Admin","Admin_Controls_Save") %></asp:LinkButton>
</div>
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            <div class="label">
               <%=BicResource.GetValue("Admin","Admin_Controls_Load") %>  Load
            </div>
            <div class="input">
                <asp:CheckBox ID="chkLoadUrl" Width="" runat="server" /></div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:CheckBox ID="chkIsActive" Checked="true" Width="" runat="server" /></div>
        </div>
    </div>
</div>
<div class="form-tool-bottom">
    <bic:ToolBar ID="tbBottom" runat="server" />
    <asp:LinkButton ID="lbtnSave2" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="AddNew"><%=BicResource.GetValue("Admin","Admin_Controls_Save") %></asp:LinkButton>
</div>