<%@Control Language="C#" AutoEventWireup="true" CodeFile="ListingTourRoute.ascx.cs" Inherits="Admin_Components_TourRoute_ListingTourRoute" %>
...
<div class="input-box"><div class="item first">
<div class="item bg_none"> <div class="label">Duyệt</div><div class="input"> <bic:DropBoolean runat="server" ID="ddlIsActive" OnSelectedIndexChanged="ddlLanguage_SelectedIndexChanged" AutoPostBack="True" /></div></div>  </div>
</div>
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("TourRouteID");
           ...
           <telerik:RadGrid ID="rgManager" EnableViewState="false" EnableEmbeddedSkins="false"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                    DataKeyNames="TourRouteID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
...
<telerik:GridBoundColumn HeaderText="Tên địa danh" DataField="Name"  />
<telerik:GridBoundColumn HeaderText="Latitude" DataField="Latitude"  HeaderStyle-Width="200" />
<telerik:GridBoundColumn HeaderText="Longitude" DataField="Longitude"  HeaderStyle-Width="150" />
<telerik:GridTemplateColumn HeaderText="Thứ tự" HeaderStyle-Width="110px"><ItemTemplate><asp:DropDownList runat="server" ID="ddlCurrentPosition" Width="45px" /><div style="float: right; position: relative;"><asp:ImageButton runat="server" ImageUrl="~/Admin/Styles/Icon/updown_30x20.png" ID="lbtnChange" CommandName="Change" /></div> </ItemTemplate></telerik:GridTemplateColumn>
<telerik:GridTemplateColumn HeaderText="Duyệt"  HeaderStyle-Width="50" > <ItemTemplate><asp:ImageButton ID="ibtnIsActive" BorderWidth="0px" CommandName="IsActive" CommandArgument='<%#Eval("IsActive") %>' ImageUrl='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "IsActive"))? "~/Admin/Styles/Icon/checkmark.gif" : "~/Admin/Styles/Icon/uncheckmark.gif" %>' Style=" cursor: pointer;" runat="server"></asp:ImageButton></ItemTemplate></telerik:GridTemplateColumn>
                   </Columns>
                </MasterTableView>
