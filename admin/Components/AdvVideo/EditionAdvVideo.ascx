<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionAdvVideo.ascx.cs" Inherits="Admin_Components_AdvVideo_EditionAdvVideo" %>
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtURL" CssClass="input-text" Width="400" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <input type="file" id="filePath" width="" class="" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtKhoangThoiGian" CssClass="input-text" Width="" runat="server" />
            </div>
        </div>
    </div>
    <%-- <div class="frow">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtTextDisplay" CssClass="input-text" Width="400" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtViewCount" CssClass="input-text" Width="100" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
...
<telerik:RadInputManager runat="server" ID="rimBICCMS" EnableEmbeddedSkins="false" Skin="BICCMS">
    ...
    <telerik:NumericTextBoxSetting BehaviorID="bhKhoangThoiGian" DecimalDigits="0">
        <TargetControls>
