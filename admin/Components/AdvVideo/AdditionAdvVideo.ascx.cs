...
public partial class Admin_Components_AdvVideo_AdditionAdvVideo : BaseUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            AdvVideoBiz.PositionWithPriorityAdd(ddlPosition);
    ...
    protected void Save(object sender, CommandEventArgs e)
    {
        try
        {
            ...
            {
                case "AddNew":
                    AdvVideoBiz.InsertAdvVideo(LoadDataToEntity());
