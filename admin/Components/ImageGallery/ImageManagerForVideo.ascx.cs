...
public partial class admin_Components_ImageGallery_ImageManagerForVideo : BaseUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //hdfLangForVideo.Value = BicHtml.GetRequestString("l") == "" ? BicXML.ToString("DefaultLanguageAdmin", "SearchEngine") : BicHtml.GetRequestString("l");
    ...
    public void BinddingImageManager()
    {
        ...
        //{
        //    data.Conditioning.Add(new ConditioningItem(ImageEntity.FIELD_NAME, string.Format("%{0}%", BicString.Trim(txtName.Text)), Operator.LIKE, CompareType.STRING));
        //}
        ...
        //if (txtName.Text != string.Empty)
        //    lblMessage.Text = string.Format("<b>Kết quả tìm kiếm: </b>Tìm được><b> {0} ảnh</b> với tên <b>\"{1}\"</b>", data.TotalItems, BicConvert.ToString(txtName.Text));
        //else
        //    lblMessage.Text = @"<b>Ảnh được tải lên gần đây nhất</b>";
