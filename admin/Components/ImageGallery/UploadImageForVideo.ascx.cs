...
public partial class admin_Components_ImageGallery_UploadImageForVideo : UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            BindListFromXML(rblResizeWidth, string.Format("{0}ResizeImage.xml", BicApplication.URLPath("Admin/XMLData")));
