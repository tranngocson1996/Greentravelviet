<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionFrameView.ascx.cs" Inherits="Admin_Components_FrameView_AdditionFrameView" %>
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                ...
                <%=BicResource.GetValue("Admin","Admin_FrameView_Oder") %>Thứ tự: {1}: MenuID, {2}:ParentID, {3}:Name, {4}:LanguageKey
            </div>
        </div>
    </div>
    <div class="frow">
