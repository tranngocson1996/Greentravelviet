<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Maps2.ascx.cs" Inherits="Controls_GoogleMap_Maps" %>
<%--<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>--%>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false"></script>
<script type="text/javascript" src='<%=Page.ResolveUrl("~/admin/Components/GoogleMap/map2.js")%>'></script>
<link type="text/css" rel="Stylesheet" href='<%=Page.ResolveUrl("~/admin/Components/GoogleMap/maps.css")%>' />
