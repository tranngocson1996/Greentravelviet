<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingCity.ascx.cs" Inherits="Admin_Components_City_ListingCity" %>
        ...
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("CityID");
            ...
            <telerik:RadGrid ID="rgManager" EnableViewState="false" EnableEmbeddedSkins="false"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                    DataKeyNames="CityID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tên Tỉnh/Thành phố" DataField="CityName" />
