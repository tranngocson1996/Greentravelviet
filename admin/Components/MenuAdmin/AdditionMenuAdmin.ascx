<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionMenuAdmin.ascx.cs" Inherits="admin_Components_MenuAdmin_AdditionMenuAdmin" %>
...
<div class="form-tool">
    ...
    <asp:LinkButton ID="lbtnSave" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="AddNew"><%=BicResource.GetValue("Admin","Admin_MenuAdmin_Save") %></asp:LinkButton>
</div>
        ...
        <div class="main">
            <div class="form-view f2">
                ...
                <div class="frow" id="divUrl">
                    ...
                    <div class="input">
                        <input type="text" runat="server" id="txtUrl" clientidmode="Static" style="width:250px" class="input-text" />
                    </div>
                </div>
                <div class="frow">
                    <div class="label">
                ...
                <div class="frow">
                    ...
                    <div class="input">
                        <input type="text" runat="server" id="txtIcon" class="input-text" width="210px" />
                    </div>
                </div>
                <div class="frow">
                    <div class="label">
...
<div class="form-tool-bottom">
    ...
    <asp:LinkButton ID="lbtnSave2" CssClass="btn-save" runat="server" OnCommand="Save" CommandName="AddNew"><%=BicResource.GetValue("Admin","Admin_MenuAdmin_Save") %></asp:LinkButton>
</div>
<telerik:RadInputManager runat="server" ID="rim1" EnableEmbeddedSkins="false" Skin="BICCMS">
    <telerik:TextBoxSetting BehaviorID="bhTitle" EmptyMessage="<%$Resources:Admin, System_InputCategoryName%>" Validation-IsRequired="true">
        <TargetControls>
