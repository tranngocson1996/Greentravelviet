<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingPromotion.ascx.cs" Inherits="Admin_Components_Promotion_ListingPromotion" %>
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false" Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter" AllowPaging="True"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..." DataKeyNames="key" ClientDataKeyNames="key" CommandItemDisplay="Top">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin, Admin_XML_Promotion_Title%>" DataField="name" HeaderStyle-Width="30%" />
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin, Admin_XML_Promotion_Content%>" DataField="value" />
