...
public partial class Admin_Components_GoogleMaps_ListingGoogleMaps : BaseUserControl
{
    ...
    public void Loaddata(string filename)
    {
        ...
        rgManager.VirtualItemCount = xmldoc.Element("GoogleMaps").Elements("key").Count();
    }
