<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdditionSupport.ascx.cs"
            Inherits="Admin_Components_Support_AdditionSupport" %>
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            <div class="label">
                <%=BicResource.GetValue("Admin","Admin_XML_Support_Title") %> 
            </div>
            <div class="input">
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtPhone" Width="300px" runat="server" CssClass="input-text" />
            </div>
        </div>
    </div>
</div>
