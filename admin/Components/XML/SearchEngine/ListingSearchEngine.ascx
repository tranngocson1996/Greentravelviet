<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingSearchEngine.ascx.cs" Inherits="Admin_Components_Support_ListingSearchEngine" %>
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false" Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter" AllowPaging="True"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..." DataKeyNames="datakey" ClientDataKeyNames="datakey"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin, Admin_XML_SearchEngine_ConfigurationName%>" HeaderStyle-Width="200px" DataField="name" />
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin, Admin_XML_SearchEngine_Value%>" DataField="value" />
                    </Columns>
                </MasterTableView>
