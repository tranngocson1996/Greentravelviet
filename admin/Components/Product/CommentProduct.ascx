<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommentProduct.ascx.cs" Inherits="admin_Components_Product_CommentProduct" %>
<%@ Import Namespace="BIC.Utils" %>
<asp:ListView runat="server" ID="lvRelatedProduct" OnItemCommand="lvRelatedProduct_ItemCommand" DataKeyNames="CommentID">
...
<div style="background: #9EC4D4; text-align: left; width:740px">
    <bic:PagerUI runat="server" ID="pRelatedProduct" PagerUIStep="10" Label="Trang: " PageSize="10" />
</div>