<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionProduct.ascx.cs" Inherits="Admin_Components_Product_EditionProduct" %>
...
<%@ Register TagPrefix="uc2" TagName="relatedproduct" Src="~/admin/Components/Product/RelatedProduct.ascx" %>
<%@ Register Src="CommentProduct.ascx" TagName="CommentProduct" TagPrefix="uc3" %>
<%@ Register Src="~/admin/Components/Article/RelatedArticle.ascx" TagPrefix="bic" TagName="RelatedArticle" %>
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:TextBox ID="txtTitle" runat="server" CssClass="input-text" Width="750px" />
            </div>
        </div>
    </div>
        ...
        <div class="frow-wrapp">
            ...
            <div class="input group-item">
                <div class="col c2 first">
                    ...
                    <div class="line">
                        <div class="label">
                            <telerik:RadCodeBlock ID="RadCodeBlock74" runat="server">
                                Mã sản phẩm
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                    ...
                    <div class="line">
                        <div class="label">
                            <telerik:RadCodeBlock ID="RadCodeBlock64" runat="server">
                                Giảm giá (%)
                            </telerik:RadCodeBlock>
                        </div>
                        <div class="input">
                ...
                <div class="col c2">
                    ...
                    <telerik:RadCodeBlock ID="RadCodeBlock15" runat="server">
                        <div class="line <%= BicXML.ToBoolean("EnableSource", "SettingProduct") == false ? "hidden" : "" %>">
                            <div class="label arrow">
    ...
    <script type="text/javascript">
        $(document).ready(function () { if ($("#ddlTypeNews").val() == 2) { $("#ArrayImage").show(); } if ($("#ddlTypeNews").val() == 3) { $("#Video").show(); }; $("#ddlTypeNews").live("change", function () { if ($(this).val() == 2) { $("#ArrayImage").show(); $("#Video").hide(); } if ($(this).val() == 3) { $("#Video").show(); $("#ArrayImage").hide(); } if ($(this).val() == 1 || $(this).val() == 4) { $("#Video").hide(); $("#ArrayImage").hide(); } }); });
    </script>

    <!--Video-->
    <div class="frow alt hidden" id="Video">
        <div class="frow-wrapp">
            <div class="label">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <%-- <bic:Editor Height="200px" Skin="Office2007" Width="98%" ID="reBriefDescription" ToolbarMode="ShowOnFocus" ToolsFile="~/admin/XMLData/Editor/SmallSetOfTools.xml" runat="server" StripFormattingOnPaste="All" />--%>
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            <div class="label">
                <telerik:RadCodeBlock ID="RadCodeBlock66" runat="server">
                    NewColumn2
                </telerik:RadCodeBlock>
            </div>
            <div class="input">
                <telerik:RadCodeBlock runat="server" ID="RadCodeBlock67">
                    <%= IncludeAdmin.RadEditor() %>
                </telerik:RadCodeBlock>
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            <div class="label">
                <telerik:RadCodeBlock ID="RadCodeBlock68" runat="server">
                    NewColumn3
                </telerik:RadCodeBlock>
            </div>
            <div class="input">
                <telerik:RadCodeBlock runat="server" ID="RadCodeBlock69">
                    <%= IncludeAdmin.RadEditor() %>
                </telerik:RadCodeBlock>
    ...
    <div class="frow hidden">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <telerik:RadCodeBlock runat="server" ID="RadCodeBlock71">
                    <%= IncludeAdmin.RadEditor() %>
                </telerik:RadCodeBlock>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock44" runat="server">
        <div class="frow alt <%= BicXML.ToBoolean("EnableRelatedNews", "SettingProduct") == false ? "hidden" : "" %>">
            <div class="frow-wrapp">
                <div class="label">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock48" runat="server">
        <div class="frow alt <%= BicXML.ToBoolean("EnableComment", "SettingProduct") == false ? "hidden" : "" %>">
            <div class="frow-wrapp">
                <div class="label">
                    <telerik:RadCodeBlock ID="RadCodeBlock35" runat="server">
                        <%= BicResource.GetValue("Admin", "Admin_Product_ListComment") %>
                    </telerik:RadCodeBlock>
                </div>
                <div class="input">
                    <telerik:RadCodeBlock ID="RadCodeBlock49" runat="server">
                        <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel2">
                            <uc3:CommentProduct ID="ucCommentProduct" runat="server" />
                        </telerik:RadAjaxPanel>
                    </telerik:RadCodeBlock>
                </div>
            </div>
