<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingProduct.ascx.cs"
            Inherits="Admin_Components_Product_ListingProduct" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            <script type="text/javascript">
                ...
                function RowGridSelected(sender, args) { key = args.getDataKeyValue("ProductID"); document.getElementById("radGridSelectedRowIndex").value = key; } function RowContextMenu(sender, eventArgs) {
            ...
            <div class="input-box">
                ...
                <div class="item">
                    ...
                    <div class="input">
                        <%--  <bic:DropBoolean runat="server" ID="ddlIsActive" CssClass="input-select" DataValueField="key"
                            DataTextField="name" />--%>
                        <asp:DropDownList runat="server" ID="ddlIsActive" CssClass="input-select">
                ...
                <div class="item" style="display: none !important">
                    <div class="label">
                        ...
                        <%= BicResource.GetValue("Admin", "Admin_Product_Spotlight") %>
                    </div>
                    <div class="input">
                ...
                <div class='item  hidden <%= BicXML.ToBoolean("EnableComment", "SettingProduct") == false ? "hidden" : "" %>' style="display: none !important">
                    <div class="label">
                        <%= BicResource.GetValue("Admin", "Admin_Product_Comment") %>
                    </div>
                    <div class="input">
                        <asp:DropDownList runat="server" ID="ddlCommentNew" CssClass="input-select">
                            <asp:ListItem Text="<%$Resources:Admin,System_All%>" Value="2" />
                            <asp:ListItem Text="<%$Resources:Admin,Admin_Product_Havebrowse%>" Value="1" />
                ...
                <div class="item bg_none">
                    ...
                    <div class="input">
                        <telerik:RadDatePicker ID="radBDBeginDate" runat="server" CssClass="input-date" Width="120px" DateInput-EmptyMessage="<%$Resources:Admin, Admin_Product_SelectDate%>"
                ...
                <div class="item">
                    <div class="label">
                        ...
                        <%= BicResource.GetValue("Admin", "Admin_Product_ToDay") %>
                    </div>
                    <div class="input">
                        <telerik:RadDatePicker ID="radBDEndDate" runat="server" CssClass="input-date" Width="120px" DateInput-EmptyMessage="<%$Resources:Admin, Admin_Product_SelectDate%>"
                                               DateInput-DateFormat="dd/MM/yyyy" ShowPopupOnFocus="True">
                        </telerik:RadDatePicker>
                    </div>
                </div>
                <div class="item bg_none">
                    <div class="input">
                        <asp:Button runat="server" ID="btnclear" Height="25px" Text="<%$Resources:Admin, Admin_Product_SkipConditions%>" OnClick="btnclear_OnClick" />
                    </div>
                </div>
                <div class="item bg_none">
                    <div class="input">
            ...
            <div class="input-side">
                <div class="tree-box">
                    ...
                    <div class="tree-title">
                        ...
                        <%= BicResource.GetValue("Admin", "Admin_Product_SearchByCategory") %>
                    </div>
        ...
        <div class="grid-side">
            ...
            <telerik:RadGrid ID="rgManager" EnableEmbeddedSkins="false"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                                 DataKeyNames="ProductID,UrlName" ClientDataKeyNames="ProductID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
                    </CommandItemTemplate>
                    <Columns>
                        <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn" HeaderStyle-Width="30px" ItemStyle-CssClass="center">
                        </telerik:GridClientSelectColumn>
                        <telerik:GridBoundColumn UniqueName="UniqueID" DataField="ProductID">
                            <HeaderStyle Width="1" />
                            <ItemStyle Width="1" />
                        ...
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin,Admin_Product_Title%>"
                                                 DataField="Title" UniqueName="Title" HeaderStyle-CssClass="rgHeader" />
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin,Admin_Product_List%>" DataField="Nhom" HeaderStyle-Width="200px" />
                        <telerik:GridTemplateColumn Visible="False" HeaderText="<%$Resources:Admin,Admin_Product_Comment%>" HeaderStyle-Width="60px" ItemStyle-CssClass="center">
                            <ItemTemplate>
                                <div title="<%= BicResource.GetValue("Admin", "Admin_Product_CommentState") %>"><%# Eval("InActiveComment") + " / " + Eval("ActiveComment") %></div>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridDateTimeColumn HeaderText="<%$Resources:Admin,Admin_Product_Update%>" DataFormatString="{0: dd/MM/yyy}"
                                                    HeaderStyle-Width="75px" ItemStyle-CssClass="center" DataField="ModifiedDate"
                                                    UniqueName="ModifiedDate">
                        </telerik:GridDateTimeColumn>
                        <telerik:GridBoundColumn HeaderText="<%$Resources:Admin,Admin_Product_Views%>" DataField="ViewCount" UniqueName="ViewCount"
                                                 HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="center">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn HeaderText="<%$Resources:Admin,System_OutOfStock%>" UniqueName="TemplateColumn" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-Width="45px">
                            <ItemTemplate>
                                <asp:ImageButton ID="isOutOfStock" BorderWidth="0px" Enabled="<%# Approved %>" CommandName="OutOfStock" CommandArgument='<%#Eval("OutOfStock") %>' ImageUrl='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem, "OutOfStock"))? "~/Admin/Styles/Icon/checkmark.gif" : "~/Admin/Styles/Icon/uncheckmark.gif" %>' Style="cursor: pointer;" runat="server"></asp:ImageButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="<%$Resources:Admin,System_Edit%>" UniqueName="TemplateColumn" ItemStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="ibtnEdit" BorderWidth="0px" Visible="<%# Edited %>" CommandName="Edit" CommandArgument='<%# Eval("ProductID") %>'
...
<telerik:RadScriptBlock ID="RadCodeBlock3" runat="server">
    <script type="text/javascript">
        function onClientItemClicked(sender, args) {
            ...
            window.radopen('<%= Page.ResolveUrl("~/admin/Components/Product/TreeViewMenuUser.aspx?id=' + id + '&l=' + AdminLanguage + '") %>', "MenuUserListDialog");
        }
...
<script>
    function MesDelete() {
        return confirm('<%= BicResource.GetValue("Admin", "Admin_Product_Message7") %>');
    }
</script>