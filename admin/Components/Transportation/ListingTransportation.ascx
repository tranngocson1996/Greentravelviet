<%@Control Language="C#" AutoEventWireup="true" CodeFile="ListingTransportation.ascx.cs" Inherits="Admin_Components_Transportation_ListingTransportation" %>
...
<div class="item bg_none"> <div class="label">Duyệt</div><div class="input"> <bic:DropBoolean runat="server" ID="ddlIsActive" OnSelectedIndexChanged="ddlLanguage_SelectedIndexChanged" AutoPostBack="True" /></div></div>
</div>
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("TransportationID");
           ...
           <telerik:RadGrid ID="rgManager" EnableViewState="false" EnableEmbeddedSkins="false"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..."
                    DataKeyNames="TransportationID" CommandItemDisplay="Top">
                    <CommandItemTemplate>
...
<telerik:GridBoundColumn HeaderText="Tên phương tiện" DataField="TenPhuongTien"  />
