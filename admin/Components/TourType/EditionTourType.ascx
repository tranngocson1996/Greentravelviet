<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditionTourType.ascx.cs" Inherits="Admin_Components_TourType_EditionTourType" %>
<div class="form-tool">
...
<div class="form-view">
    ...
    <div class="frow">
        <div class="frow-wrapp">
            ...
            <div class="input">
                <asp:DropDownList ID="ddlPriority" Width="50" CssClass="input-select" runat="server" />
            </div>
        </div>
    </div>
    <div class="frow">
