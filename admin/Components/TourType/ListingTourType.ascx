<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListingTourType.ascx.cs" Inherits="Admin_Components_TourType_ListingTourType" %>
    ...
    <telerik:RadAjaxPanel RestoreOriginalRenderDelegate="false" ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <div class="grid">
            ...
            <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                <script type="text/javascript">
                    function RowGridSelected(sender, args) {
                        key = args.getDataKeyValue("TourTypeID");
            ...
            <telerik:RadGrid ID="rgManager" EnableViewState="false" EnableEmbeddedSkins="false" Skin="BICCMS" runat="server" HeaderStyle-CssClass="rgHeader rgHeaderCenter"
                ...
                <MasterTableView TableLayout="Fixed" NoMasterRecordsText="Kh&ocirc;ng c&oacute; d&#7919; li&#7879;u..." DataKeyNames="TourTypeID"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Tên hình thức" DataField="TenHinhThuc" HeaderStyle-HorizontalAlign="Center" />
                        <telerik:GridBoundColumn HeaderText="Thứ tự" DataField="Priority" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"
