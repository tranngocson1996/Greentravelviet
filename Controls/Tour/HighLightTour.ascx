<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HighLightTour.ascx.cs" Inherits="Controls_Tour_HighLightTour" %>
                ...
                <div class="item">
                    <div class="tns-item">
                        ...
                        <div class="info-hottour">
                            ...
                            <div class="content">
                                <div class="transport"><%=BicResource.GetValue("transport") %> : <%#Eval("PhuongTienHienThi") %></span></div>
